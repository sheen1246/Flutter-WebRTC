...
var MY_ID = 12022000 + Random().nextInt(1000);
Socket socket;
...
class _HomePageState extends State<HomePage> {
  ...
  void switchCamera() async {
    if (_localStream != null) {
      ...
      bool value = await RTC.Helper.switchCamera(_localStream.getVideoTracks()[0]);
  ...
  void connectAndListen() async {
    var urlConnectSocket = 'http://192.168.0.54:3000';
    socket =
  ...
  _createPeerConnection() async {
    ...
    RTC.RTCPeerConnection pc = await RTC.createPeerConnection(configuration, constraints);
